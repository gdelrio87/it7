 ...
 * [servicerest.editorial]<br>
 * USAGE:
 * <pre>
 *        JerseyClientEditorial client = new JerseyClientEditorial();
 ...
 * @author Gonza
 */
public class JerseyClientEditorial {

    private WebTarget webTarget;
    private Client client;
    private static final String BASE_URI = "http://localhost:8080/p4/webresources";

    public JerseyClientEditorial() {
        client = javax.ws.rs.client.ClientBuilder.newClient();
        webTarget = client.target(BASE_URI).path("servicerest.editorial");
    }
    ...
    public void create_XML(GenericType requestEntity) throws ClientErrorException {
        webTarget.request(javax.ws.rs.core.MediaType.APPLICATION_XML).post(javax.ws.rs.client.Entity.entity(requestEntity, javax.ws.rs.core.MediaType.APPLICATION_XML));
    }

    public void create_JSON(GenericType requestEntity) throws ClientErrorException {
