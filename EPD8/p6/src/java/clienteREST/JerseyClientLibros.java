 ...
 * [servicerest.libro]<br>
 * USAGE:
 * <pre>
 *        JerseyClientLibros client = new JerseyClientLibros();
 ...
 * @author Gonza
 */
public class JerseyClientLibros {

    private WebTarget webTarget;
    private Client client;
    private static final String BASE_URI = "http://localhost:8080/p4/webresources";

    public JerseyClientLibros() {
        client = javax.ws.rs.client.ClientBuilder.newClient();
        webTarget = client.target(BASE_URI).path("servicerest.libro");
    }
