 ...
 * USAGE:
 * <pre>
 *        JerseyClientPelicula client = new JerseyClientPelicula();
 ...
 * @author Gonza
 */
public class JerseyClientPelicula {

    private WebTarget webTarget;
    private Client client;
    private static final String BASE_URI = "http://localhost:8080/p7/webresources";

    public JerseyClientPelicula() {
        client = javax.ws.rs.client.ClientBuilder.newClient();
        webTarget = client.target(BASE_URI).path("datos.pelicula");
    }
