...
@NamedQueries({
    ...
    , @NamedQuery(name = "Viaje.findByFechaHoraSalida", query = "SELECT v FROM Viaje v WHERE v.fechaHoraSalida = :fechaHoraSalida")})
public class Viaje implements Serializable {
    ...
    public Viaje(Integer idViaje, String puntoRecogida, int plazasMax, double percioPersona, Date fechaHoraSalida) {
        this.idViaje = idViaje;
