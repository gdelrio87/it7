 ...
 * USAGE:
 * <pre>
 *        JerseyClientPuntuacion client = new JerseyClientPuntuacion();
 ...
 * @author Gonza
 */
public class JerseyClientPuntuacion {

    private WebTarget webTarget;
    private Client client;
    private static final String BASE_URI = "http://localhost:8080/WebService/webresources";

    public JerseyClientPuntuacion() {
        client = javax.ws.rs.client.ClientBuilder.newClient();
        webTarget = client.target(BASE_URI).path("ws.puntuacion");
    }
